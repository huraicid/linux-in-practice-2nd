# 本書で使用する Docker イメージを作成するための Dockerfile
# Thanks to https://github.com/Msksgm/linux-in-practice-2nd-docker
# https://zenn.dev/msksgm/articles/20230814-linux-in-practice-2nd-docker
#
# 以下のコマンドでビルド可能
